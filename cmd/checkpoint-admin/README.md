...
```shell
go get github.com/ignitechain/ignitechain-beta/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/ignitechain/ignitechain-beta/blob/master/params/config.go#L251).*
